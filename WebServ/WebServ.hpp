...
/*   Updated: 2020/12/18 16:43:43 by imicah           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
private:
	...
	bool _CheckError(Client* client, VirtualServer* virtual_server, Location* location, struct stat& buff,
					 std::string& path_to_target);
	void
	_SetErrorPage(Client *client, Location *location, VirtualServer *virtual_server);
